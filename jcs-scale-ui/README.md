...
Navigate to the Overview page. Click Add Node incon.
...
After a few moments the Overview tile will show Scaling... and the service instance will change to maintenance mode (yellow exclamation mark). If it has not changed click the Refresh icon to update the page.
